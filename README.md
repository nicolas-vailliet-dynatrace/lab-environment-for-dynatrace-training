...
You can create several ubuntu VM, for example for 2 VM with this domain name = dynatracelab20191202140023, we will create on azure these 2 VM with the size = Standard_F1 (1 CPU; 2GB RAM; 16 GB Disk; 0,0420€/hour):  
